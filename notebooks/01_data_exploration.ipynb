...
**Goal:** Understand the dataset structure, data types, shape, and quality before any analysis.
...
cat_cols = ['Channel_Used', 'Campaign_Goal', 'Target_Audience',
...
---
**Next notebook:** `02_cleaning_feature_eng.ipynb`
